...
from mjlab.asset_zoo.robots.hector_v2.hector_v2_constants import (
  H2_ACTION_SCALE,
  H2_ROBOT_CFG,
)
...
@dataclass
class Hectorv2RoughEnvCfg(LocomotionVelocityEnvCfg):
  def __post_init__(self):
    ...
    foot_contact_sensors = [
      ContactSensorCfg(
        ...
        body1=f"{side}_ankle_pitch_link",
        body2="terrain",
        num=1,
        data=("found",),
        reduce="netforce",
    ...
    m1_cfg = replace(H2_ROBOT_CFG, sensors=tuple(foot_contact_sensors))
    ...
    self.actions.joint_pos.scale = H2_ACTION_SCALE
...
@dataclass
class Hectorv2RoughEnvCfg_PLAY(Hectorv2RoughEnvCfg):
  def __post_init__(self):
    super().__post_init__()
